-- =============================================================================
-- 0039 - Loja e criacao de pedido passam a seguir o horario do delivery
--
-- Separada da 0038 de proposito: a 0038 so acrescenta (tabela, colunas e a
-- funcao delivery_estado), e esta troca quem o pedido consulta. Assim a regra
-- foi testada no banco antes de qualquer pedido depender dela.
-- =============================================================================

-- Configuracoes publicas: estado calculado e o horario da semana (rodape da
-- loja). delivery_enabled segue saindo, agora calculado, para a versao do app
-- que ainda estiver no ar durante o deploy.
...
-- Criacao do pedido: igual a 0037, trocando delivery_enabled pela regra.
