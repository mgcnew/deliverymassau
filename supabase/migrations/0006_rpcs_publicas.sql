-- =============================================================================
-- 0006 - RPCs do portal publico (cliente sem login)
-- O cliente publico NUNCA faz insert direto em orders. Tudo passa por aqui.
-- =============================================================================
...
as $$
  select jsonb_build_object(
    ...
    'payment_methods', (
      select coalesce(jsonb_agg(jsonb_build_object('code', pm.code, 'label', pm.label)
...
-- Acompanhamento do pedido pelo cliente (area do cliente, sem login) ----------
